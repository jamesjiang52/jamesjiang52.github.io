...
function UGSlider(){
	...
	var g_options = {
		  ...
		  slider_scale_mode_media: "fit",				//fill, fit, down, fitvert - scale mode on media items
		  slider_scale_mode_fullscreen: "fit",			//fill, fit, down, fitvert - scale mode on fullscreen.
		  ...
		  slider_zoom_mousewheel: false,					//enable zoom on mousewheel
...
function UniteGalleryMain(){
	...
	var g_options = {				
			gallery_width:420,							//gallery width		
...
function UGLightbox(){
	...
	var g_defaults = {
			...
			lightbox_slider_scale_mode_media: "fit",
			lightbox_slider_scale_mode: "fit",
...
$("#gallery-modelling-essay-1").unitegallery({
	gallery_theme: "slider",
});

$("#gallery-esp-1").unitegallery({
	gallery_theme: "slider",
});

$("#gallery-modelling-essay-2").unitegallery({
	gallery_theme: "slider",
});

$("#gallery-bmec").unitegallery({
	gallery_theme: "slider",
});

$("#gallery-esp-2").unitegallery({
	gallery_theme: "slider",
});